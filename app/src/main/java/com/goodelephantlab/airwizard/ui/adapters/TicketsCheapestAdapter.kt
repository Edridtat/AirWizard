...
import com.goodelephantlab.airwizard.data.model.CheapTicket
...
class TicketsCheapestAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    private var elements = arrayListOf<CheapTicket>()
    ...
    fun setData(elements: ArrayList<CheapTicket>) {
        this.elements.clear()
